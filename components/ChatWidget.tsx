  ...
  return (
    <>
      <style jsx global>{`
        ...
        .dnh-qbtn { background: none; border: 1px solid #ddd4ca; border-radius: 20px; padding: 5px 11px; font-size: 11.5px; color: #5a4e47; cursor: pointer; font-family: 'Jost', sans-serif; transition: all 0.15s; white-space: nowrap; }
        ...
        #dnh-input { flex: 1; border: 1px solid #d4c9c0; border-radius: 22px; padding: 9px 15px; font-size: 13.5px; font-family: 'Jost', sans-serif; background: #fff; color: #1a1410; outline: none; transition: border-color 0.15s; }
        ...
        .dnh-panel-copy span { font-family: 'Jost', sans-serif; font-size: 15px; color: #AC3438; line-height: 1.5; }
        .dnh-inline-link { display: inline-flex; align-items: center; gap: 6px; color: #AC3438; font-family: 'Jost', sans-serif; font-size: 12px; letter-spacing: 0.07em; text-transform: uppercase; cursor: pointer; border: none; background: none; padding: 0; transition: opacity 0.15s; }
